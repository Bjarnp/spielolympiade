...
async function main() {
  ...
  await prisma.$transaction([
    prisma.game.create({ data: { id: 'p22vc24m2', name: `Bierpong`, rules: `6 Becher` } }),
    prisma.game.create({ data: { id: 'goip3j584', name: `Flunkyball`, rules: `1 Bier pro Person` } }),
    prisma.game.create({ data: { id: 'k3d37w0zi', name: `Kastenrennen`, rules: `1 Bier pro Person` } }),
    prisma.game.create({ data: { id: '2wib896t3', name: `BIG Pong`, rules: `Bierpong auf dem Rasen` } })
  ]);
